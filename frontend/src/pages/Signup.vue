<template>
  <div class="landing-container">
    ...
    <div class="w-1/2 h-full">
      <img src="@/assets/middlebrook.png" alt="City at sunset" class="w-full h-full object-cover" />
    </div>

    <!-- Right Side: Signup Form (transparent) -->
      ...
      <div class="w-full max-w-md p-8">
        ...
        <div class="pt-8">
          <p class="text-center text-gray-600 text-sm">
            ...
            <RouterLink to="/login" class="text-purple-600 font-medium hover:text-purple-500">
              Log in
            </RouterLink>
          </p>
        </div>
